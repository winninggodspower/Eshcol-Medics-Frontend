        ...
        <div className='mt-[42px] md:mt-[34px] font-inter'>
          <div className="flex justify-between border w-[90%] md:w-[83%] max-w-[519px] mx-auto py-5 px-8">
            <div className='flex items-center text-sm gap-7 md:text-xl'>
              <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g clip-path="url(#clip0_70_3221)">
                  <path d="M17.5 24.5C21.366 24.5 24.5 21.366 24.5 17.5C24.5 13.634 21.366 10.5 17.5 10.5C13.634 10.5 10.5 13.634 10.5 17.5C10.5 21.366 13.634 24.5 17.5 24.5Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M14.6992 18.8999C14.6992 18.8999 15.7492 20.2999 17.4992 20.2999C19.2492 20.2999 20.2992 18.8999 20.2992 18.8999" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M15.4004 15.3999H15.4074" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M19.5996 15.3999H19.6066" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
          ...
          <div className="flex justify-between border w-[90%] md:w-[83%] max-w-[519px] mx-auto py-5 px-8 mt-[15px]">
            <div className='flex items-center text-sm gap-7 md:text-xl'>
              <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="17.5" cy="17.5" r="17.5" fill="#352E43" />
                <g clip-path="url(#clip0_70_3229)">
                  <path d="M23.7988 11.8999H11.1988C10.4256 11.8999 9.79883 12.5267 9.79883 13.2999V21.6999C9.79883 22.4731 10.4256 23.0999 11.1988 23.0999H23.7988C24.572 23.0999 25.1988 22.4731 25.1988 21.6999V13.2999C25.1988 12.5267 24.572 11.8999 23.7988 11.8999Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M9.79883 16.1001H25.1988" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
          ...
          <div className="flex justify-between border w-[90%] md:w-[83%] max-w-[519px] mx-auto py-5 px-8 mt-[15px]">
            <div className='flex items-center text-sm gap-7 md:text-xl'>
              <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="17.5" cy="17.5" r="17.5" fill="#352E43" />
                <path d="M23.1004 23.8001V22.4001C23.1004 21.6575 22.8054 20.9453 22.2803 20.4202C21.7552 19.8951 21.043 19.6001 20.3004 19.6001H14.7004C13.9578 19.6001 13.2456 19.8951 12.7205 20.4202C12.1954 20.9453 11.9004 21.6575 11.9004 22.4001V23.8001" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M17.4992 16.8002C19.0456 16.8002 20.2992 15.5466 20.2992 14.0002C20.2992 12.4538 19.0456 11.2002 17.4992 11.2002C15.9528 11.2002 14.6992 12.4538 14.6992 14.0002C14.6992 15.5466 15.9528 16.8002 17.4992 16.8002Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              Next of kin
            </div>
            <EditIcon />
            ...
            <div className='flex items-center text-sm gap-7 md:text-xl'>
              <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g clip-path="url(#clip0_70_3247)">
                  <path d="M21.5833 16.9165H13.4167C12.7723 16.9165 12.25 17.4388 12.25 18.0832V22.1665C12.25 22.8108 12.7723 23.3332 13.4167 23.3332H21.5833C22.2277 23.3332 22.75 22.8108 22.75 22.1665V18.0832C22.75 17.4388 22.2277 16.9165 21.5833 16.9165Z" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M14.584 16.9165V14.5832C14.584 13.8096 14.8913 13.0678 15.4383 12.5208C15.9852 11.9738 16.7271 11.6665 17.5007 11.6665C18.2742 11.6665 19.0161 11.9738 19.563 12.5208C20.11 13.0678 20.4173 13.8096 20.4173 14.5832V16.9165" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
