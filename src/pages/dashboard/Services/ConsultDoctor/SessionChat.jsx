  ...
  return (
    <div className='flex h-full'>
      ...
      <div id="chat" className='relative h-full grow md:border-e-4'>
        ...
        <div className="absolute bottom-0 w-full py-3 md:py-6 before:content-[''] before:block before:absolute before:bottom-0 before:start-0 before:w-full before:h-full before:bg-grey-3  before:opacity-70">
          <form action="" className='w-[83%] mx-auto h-11 md:h-14 relative'>
            ...
            <button type='button' className="absolute left-0 w-14 md:w-20 h-full bg-tertiary rounded-3xl">
