...
function RegisterIndividualOrHospital() {
  return (
    <section className="w-full max-w-[90%] mx-auto pb-5 md:pt-24 pt-24 font-inter">
      ...
      <div className="flex items-center justify-center gap-6">
        ...
        <div className="flex flex-col items-center gap-5 md:gap-8">
          ...
          <button className="btn md:text-base text-[0.875rem] py-0 px-0 md:py-3 md:px-6 font-medium rounded-md text-black md:bg-secondary md:text-white">I work with a hospital</button>
        </div>
        ...
        <div className="flex flex-col items-center gap-5 md:gap-8">
          ...
          <button className="btn md:text-base text-[0.875rem] py-0 px-0 md:py-3 md:px-6 font-medium rounded-md text-black md:bg-main md:text-white" >I work alone</button>
        </div>
      </div>
    </section>
  )
