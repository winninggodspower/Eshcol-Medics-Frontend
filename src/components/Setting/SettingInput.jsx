...
function SettingInput({label, defaultValue, type}) {
    ...
    return (
        <label className="flex justify-between items-center border border-grey-8 border-opacity-40 w-[80%] md:w-[84%] max-w-[519px] mx-auto py-4 px-7 md:px-[54px] md:py-5 mt-[15px] relative mb-4 md:mb-7">
            <input ref={inputRef} className="p-0 text-sm font-light border-0 md:text-xl opacity-40 focus:border-0 focus:outline-none focus:ring-0 " type={type} defaultValue={defaultValue} disabled={isDisable} />
