                    ...
                    <div className='flex flex-col items-center gap-[0.6rem] relative'>
                        <div className={`flex items-center justify-center  h-[3.125rem] w-[3.125rem] rounded-full  ${step >= 4 ? 'bg-secondary' : 'bg-grey-4'}`}>
                            ...
                            <g  opacity={step >= 4 ? 1 : 0.5} id="user 1">
                                <path id="Vector" d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 5.92172 15.4214 5.17157 16.1716C4.42143 16.9217 4 17.9391 4 19V21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                ...
                <div className='flex items-center justify-center h-[3.125rem] w-[3.125rem] rounded-full bg-secondary md:hidden'>
                    ...
                    {step == 4 && (
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="user 1">
                                <path id="Vector" d="M20 21V19C20 17.9391 19.5786 16.9217 18.8284 16.1716C18.0783 15.4214 17.0609 15 16 15H8C6.93913 15 5.92172 15.4214 5.17157 16.1716C4.42143 16.9217 4 17.9391 4 19V21" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
