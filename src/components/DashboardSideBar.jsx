...
function DashboardSideBar() {
  return (
    <aside className='w-full md:w-1/4 sm:w-2/6 md:min-w-fit h-full font-inter border-e-2'>
        <div className="flex items-center gap-6 ps-12 py-8">
            <img src={profileAvater} style={{width: "5.625rem"}} />
            <div className="">
        ...
        <div className="pt-5 pb-11 md:pb-9">
          <div className="flex justify-center items-center md:justify-start md:ps-20 gap-2 mb-2 md:mb-5 ">
            <svg xmlns="http://www.w3.org/2000/svg" style={{width: "1.5rem"}} viewBox="0 0 24 24" fill="none">
              <g clip-path="url(#clip0_835_1879)">
            ...
            <p className="text-lg leading-none">Patient hitory</p>
          </div>
          ...
          <div className="flex justify-center items-center md:justify-start md:ps-[6.8rem] gap-1">
            ...
            <span className="text-base leading-none opacity-50 italic">Nothing to show here</span>
          </div>
        </div>


        <div className="border-t-2">
          <NavLink className="flex gap-7 border-b-4 py-7 ps-20 bg-secondary text-white">
          ...
          <NavLink className="flex gap-7 border-b-2 py-7 ps-20">
            ...
            <p className="text-lg leading-none">How to use?</p>
          </NavLink>
          <NavLink className="flex gap-7 border-b-2 py-7 ps-20">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <p className="text-lg leading-none">Prescribe</p>
          </NavLink>
          <NavLink className="flex gap-7 border-b-2 py-7 ps-20">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <g clip-path="url(#clip0_835_1860)">
            ...
            <p className="text-lg leading-none">Settings</p>
          </NavLink>
        </div>
    </aside>
  )
