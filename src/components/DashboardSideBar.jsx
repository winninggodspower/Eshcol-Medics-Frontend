...
function DashboardSideBar() {
  return (
    <aside className='w-full md:w-1/4 sm:w-2/6 md:min-w-fit md:h-[calc(100vh-4.65rem)] font-inter border-e-2 '>
        <div className="flex items-center gap-5 ps-12 py-6">
        ...
        <div className="pt-2 pb-10 md:pb-8">
          <div className="flex justify-center items-center md:justify-start md:ps-20 gap-2 mb-2 md:mb-3 ">
          ...
          <div className="flex justify-center items-center md:justify-start md:ps-[6.8rem] gap-1">
            ...
            <span className="text-sm leading-none opacity-50 italic">Nothing to show here</span>
          </div>
        </div>


        <div className="border-t-2">
          <NavLink className="flex gap-5 border-b-4 py-6 ps-20 bg-secondary text-white">
            ...
            <p className="leading-none text-base">Home</p>
          </NavLink>
