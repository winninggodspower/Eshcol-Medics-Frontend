...
function DashboardSideBar() {
  return (
    <aside className='w-full md:w-[30%] sm:w-2/6 md:min-w-fit md:min-h-[calc(100vh-4.65rem)] min-h-fit font-inter border-e-4 fixed -translate-x-full md:static md:translate-x-0 '>
